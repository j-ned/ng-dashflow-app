...
export const BUDGET_CATEGORIES: readonly BudgetCategory[] = [
  {
    key: 'housing',
    label: 'Logement',
    i18nKey: 'budget.analytics.category.housing',
    color: 'var(--color-ib-blue)',
  },
  {
    key: 'transport',
    label: 'Transport',
    i18nKey: 'budget.analytics.category.transport',
    color: 'var(--color-ib-cyan)',
  },
  {
    key: 'food',
    label: 'Alimentation',
    i18nKey: 'budget.analytics.category.food',
    color: 'var(--color-ib-green)',
  },
  {
    key: 'health',
    label: 'Santé',
    i18nKey: 'budget.analytics.category.health',
    color: 'var(--color-ib-red)',
  },
  {
    key: 'leisure',
    label: 'Loisirs',
    i18nKey: 'budget.analytics.category.leisure',
    color: 'var(--color-ib-purple)',
  },
  {
    key: 'subscription',
    label: 'Abonnement',
    i18nKey: 'budget.analytics.category.subscription',
    color: 'var(--color-ib-orange)',
  },
  {
    key: 'insurance',
    label: 'Assurance',
    i18nKey: 'budget.analytics.category.insurance',
    color: 'var(--color-ib-yellow)',
  },
  {
    key: 'envelope',
    label: 'Enveloppe',
    i18nKey: 'budget.analytics.category.envelope',
    color: 'var(--color-ib-cyan)',
  },
  {
    key: 'repayment',
    label: 'Remboursement',
    i18nKey: 'budget.analytics.category.repayment',
    color: 'var(--color-ib-pink)',
  },
  {
    key: 'other',
    label: 'Autre',
    i18nKey: 'budget.analytics.category.other',
